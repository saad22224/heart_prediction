        ...
        <div class="row">
            ...
            <div class="col-md-6 mx-auto">
                <div class="registration-form">
                    <form action="../handeler/handeler.php" method="POST">
                        ...
                        <?php endif; ?>
                        <h4 class="text-center header" style="color: black;"> Admin Login  </h4>
                        <div class="form-group">
                            <label for="email">Username<span style="color: red;">*</span></label>
                            <input type="email" class="form-control mail" 
                            style="border-radius: 10px;" id="email" name="email" placeholder=" Username">
                        </div>
                        <div class="form-group">
                            <label for="pass">Password<span style="color: red;">*</span></label>
                            <input type="password" class="form-control pass" style="border-radius: 10px;"
                        ...
                        <div class="form-group">
                            ...
                            style="border-radius: 10px;" class="btn log btn-block btn-info" value="Login">
                        </div>
                    </form>
                </div>
            </div>
